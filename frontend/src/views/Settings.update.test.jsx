...
const mocks = vi.hoisted(() => {
  ...
  state.checkForUpdate = vi.fn(() => Promise.resolve({ hasUpdate: true, latestVersion: '9.9.9', apkUrl: 'https://x/liftboi.apk', hashUrl: null }))
...
const updateRow = () => [...host.querySelectorAll('.lrow')].find(r => r.textContent.includes('LiftBoi v9.9.9 available'))
