...
export default function Home() {
  ...
  return <div className="narrow">
    <div className="hdr">
      <div><h1 className={user ? undefined : 'wordmark'}>{user ? t('Hi {0}', user.name) : 'LiftBoi'}</h1><div className="sub">{today.toLocaleDateString(dateLocale(), { weekday: 'long', day: 'numeric', month: 'long' })}</div></div>
