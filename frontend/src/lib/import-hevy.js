...
// Hevy primary_muscle_group → LiftBoi body-part for exercises we invent.
const HEVY_BP = {
...
/**
 * Hevy routine → LiftBoi routine config.
...
export function parseHevyRoutines(routines, templates, { unit = 'kg' } = {}) {
  ...
  for (const r of routines || []) {
    const ex = []
    const sgMap = new Map() // Hevy superset_id → LiftBoi sg token
