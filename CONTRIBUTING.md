# Contributing to LiftBoi

Thanks for taking a look! LiftBoi is intentionally small and dependency-light, and the goal is
...
| A question, or self-hosting that won't behave | [An issue labelled `question`](https://github.com/5anku/LiftBoi/-/issues) |
| An idea you're not sure about yet | [An issue labelled `idea`](https://github.com/5anku/LiftBoi/-/issues) |
| A reproducible bug | [Issues](https://github.com/5anku/LiftBoi/-/issues) |
