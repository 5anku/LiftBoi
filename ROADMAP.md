...
Where LiftBoi is going, in the order it is likely to land. Each block is a GitLab milestone; the
...
- Board: https://github.com/5anku/LiftBoi/-/boards — planned → in progress → in review → closed
- Milestones: https://github.com/5anku/LiftBoi/-/milestones
