...
<img src="assets/banner.png" alt="LiftBoi" width="720">
...
<br>
[![Pipeline](https://github.com/5anku/LiftBoi/badges/main/pipeline.svg?style=flat-square)](https://github.com/5anku/LiftBoi/-/pipelines)
[![Coverage](https://github.com/5anku/LiftBoi/badges/main/coverage.svg?job=test:frontend&style=flat-square)](https://github.com/5anku/LiftBoi/-/pipelines?ref=main)
[![Release](https://github.com/5anku/LiftBoi/-/badges/release.svg?style=flat-square)](https://github.com/5anku/LiftBoi/-/releases)
![Last commit](https://img.shields.io/gitlab/last-commit/DuarteSantos8%2Fliftboi?style=flat-square)
[![Stars](https://img.shields.io/gitlab/stars/DuarteSantos8%2Fliftboi?style=flat-square)](https://github.com/5anku/LiftBoi/-/starrers)
[![Issues](https://img.shields.io/gitlab/issues/open/DuarteSantos8%2Fliftboi?style=flat-square)](https://github.com/5anku/LiftBoi/-/issues)
...
### [🌐 liftboi.duarte-santos.ch](https://liftboi.duarte-santos.ch) · [📦 Source on GitLab](https://github.com/5anku/LiftBoi)

Screenshots, docs and the APK download live on the site.<br>
<sub>Want to poke at it first? The <a href="https://liftboi.duarte-santos.ch/demo/">in-browser
...
disappear when the startup does. LiftBoi is the opposite: **it runs on your box, your data
...
- 📱 **Standalone Android app** — the whole tracker as a sideloadable APK: no account, no server, data on the phone, native workout reminders, and an **in-app update check** that downloads the next signed APK and verifies its checksum ([download](https://liftboi.duarte-santos.ch))
...
```bash
git clone https://github.com/5anku/LiftBoi
cd LiftBoi
cp .env.example .env
...
> **About that media:** it reaches LiftBoi through
...
> LiftBoi's AGPL, and their ownership is currently disputed between Gym visual and ExerciseDB.
> LiftBoi ships none of it: your instance downloads it from upstream. Reusing it yourself,
...
- **Android:** [**download the APK**](https://liftboi.duarte-santos.ch) — or straight from
  [GitLab's package registry](https://github.com/5anku/LiftBoi/-/packages), where every
  build sits next to its `.sha256` — and sideload it; LiftBoi is deliberately not on the Play
...
The full HTTP API is documented as an OpenAPI spec in [`api/openapi.yaml`](api/openapi.yaml) — browsable at [liftboi.duarte-santos.ch/api.html](https://liftboi.duarte-santos.ch/api.html).
...
| `RP_NAME`     | Name shown in the passkey prompt                     | `LiftBoi`               |
...
[GitLab milestones](https://github.com/5anku/LiftBoi/-/milestones): v1.3.5 programmes and
...
[board](https://github.com/5anku/LiftBoi/-/boards) shows what is planned, in progress and
...
- **[Issues](https://github.com/5anku/LiftBoi/-/issues)** — bugs, questions, self-hosting
...
- **Merge requests** — [open one on GitLab](https://github.com/5anku/LiftBoi/-/merge_requests); see
  [CONTRIBUTING.md](CONTRIBUTING.md).

> **On the GitHub repo:** `github.com/DuarteSantos8/LiftBoi` is offline because the account was
> suspended. **GitLab is the home of the project** — same history, same tags, same releases, and
> the CI that builds the images and the APK runs there. (gitea.com/DuarteSantos/LiftBoi was the
...
LiftBoi is free and stays free: AGPL, no subscription, no paid tier, nothing held back for
...
**LiftBoi's own code** is [GNU AGPL v3.0](LICENSE) — free and open source. You can self-host,
use, modify and share it; if you run a modified version as a network service, you must offer that
version's source under the same license. Nobody can turn LiftBoi into a closed, proprietary
product.

**Third-party content is not, and LiftBoi cannot sublicense it.** The exercise metadata and
instruction text originate from [ExerciseDB v1](https://exercisedb.dev/) and reach LiftBoi through
...
clarification has been requested. LiftBoi does not redistribute them (your instance fetches them
